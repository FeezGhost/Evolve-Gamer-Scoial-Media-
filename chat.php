...
<link rel="stylesheet" href="onchatsty.css">
    <title>Evolve</title>
</head>
<body>
    <nav class="heder navbar navbar-expand-sm navbar-dark">
...
<h3 class=" text-center">Direct Messages</h3>
      <div class="inbox_msg">
          ...
          <div class="inbox_chat">
            <div class="chat_list active_chat">
              <div class="chat_people">
                ...
                <div class="chat_ib">
                  <h5 class="text-white">Person <span class="chat_date">Dec 25</span></h5>
                </div>
              </div>
            </div>
            <div class="chat_list">
